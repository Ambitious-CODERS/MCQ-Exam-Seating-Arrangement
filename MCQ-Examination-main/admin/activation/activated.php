...
<body class="bodycolor">
    ...
    <div class="jumbotron container">
        ...
        function activate($server_name, $username, $password, $database_name, $port) {
            if (isset($_POST['activate']) && isset($_POST['activateopt'])) {
                ...
                echo "<h2>No quiz selected for activation.</h2>";
            }
        }
        activate($server_name, $username, $password, $database_name, $port);
        ?>
        </center>
    </div>
